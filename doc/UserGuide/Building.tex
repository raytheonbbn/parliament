...
To get started, download the Boost source distribution (version 1.78.0 or later) from the Boost web site.  Unpack this to a handy location on your disk.  This location may be anywhere you like.  Define this environment variable pointing there:

{
	%\renewcommand{\arraystretch}{1.5}
	\renewcommand{\tabcolsep}{0pt}
	\begin{tabular}{l@{\hspace{2em}}l}
		\verb|set BOOST_ROOT=C:\boost_1_78_0|
			& (on Windows)\\
		\verb|export BOOST_ROOT=~/boost_1_78_0|
...
toolset=msvc define=BOOST_TEST_ALTERNATIVE_INIT_API
...
This will build the libraries in \path|stage-gcc/lib|.  If your compiler does not support the C++17 standard, change ``17'' to ``14'' in the above command (in two places).  The following commands will delete intermediate build products to save disk space:
...
\begin{itemize}
	...
	\item\verb|BOOST_VERSION|: The version of Boost (currently 1\_78\_0).
...
\begin{quote}
	\texttt{targets/parliament-\textbf{\textit{x.y.z}}-\textbf{\textit{platform}}}
\end{quote}
