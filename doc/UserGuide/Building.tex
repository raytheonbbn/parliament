...
To get started, download the Boost source distribution (version 1.76.0 or later) from the Boost web site.  Unpack this to a handy location on your disk.  This location may be anywhere you like.  Define this environment variable pointing there:

{
	%\renewcommand{\arraystretch}{1.5}
	\renewcommand{\tabcolsep}{0pt}
	\begin{tabular}{l@{\hspace{2em}}l}
		\verb|set BOOST_ROOT=C:\boost_1_76_0|
			& (on Windows)\\
		\verb|export BOOST_ROOT=~/boost_1_76_0|
...
\begin{itemize}
	\item\verb|JAVA_HOME|: The location of your JDK installation, which must be version 11 or higher.
	...
	\item\verb|BOOST_VERSION|: The version of Boost (currently 1\_76\_0).
