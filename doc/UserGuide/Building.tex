...
\begin{itemize}
	...
	\item\path|jena/SpatialIndex|: A KbGraph add-on for processing spatial queries efficiently
	\item\path|jena/TemporalIndex|: A similar add-on to speed up temporal queries
\end{itemize}
