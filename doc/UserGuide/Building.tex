...
\ac{pmnt} uses \ac{lmdb}\urlcite{http://www.lmdb.tech/doc/}, an embedded database manager from the OpenLDAP Project\urlcite{https://www.openldap.org/project/}.  \ac{lmdb} is licensed under BSD-style license called the OpenLDAP Public License\urlcite{https://www.openldap.org/software/release/license.html}.  The following procedures are based on \ac{lmdb} version \lmdbversion.

\subsection{Building \ac{lmdb} for Windows}

\subsection{Building \ac{lmdb} for Macintosh}

Navigate to the releases page of \acp{lmdb} GitHub site\urlcite{https://github.com/LMDB/lmdb/releases}. Click the Tags button and download version \lmdbversion. Expand the archive in a convenient location and switch to the \path|libraries/liblmdb| subdirectory. Issue this command:
\begin{verbatim}
