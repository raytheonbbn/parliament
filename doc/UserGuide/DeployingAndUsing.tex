...
\begin{enumerate}
	...
	\begin{quote}
		\path|.\parliament.ps1 -interactive|
	\end{quote}
...
\begin{quote}
	\path|parliament interactive|\hfill(on Linux/UNIX)\\
	\path|.\parliament.ps1 -interactive|\hfill(on Windows)
\end{quote}
...
\begin{quote}
	\path~parliament {interactive|install}~\hfill(on Linux/UNIX)\\
	\path|.\parliament.ps1 -interactive|\hfill(on Windows)
\end{quote}
