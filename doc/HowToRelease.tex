...
\begin{enumerate}
	...
	\item If the compiler has been updated, consider rebuilding the Boost and RocksDB libraries.  (See the User Guide for details.)
...
\begin{verbatim}
   ...
   ant -Ddistro=../../target/distro/
         parliament-3.0.0-ubuntu20-64.zip
   cp ../../target/distro/
         parliament-3.0.0-ubuntu-docker.tar.bz2 release
\end{verbatim}
...
\begin{verbatim}
   ...
   git tag -a -m "Dependencies archive released on
         2022-04-25 prior to releasing version 3.0.0"
...
\begin{verbatim}
   git tag -a -m "Release version 3.0.0, created 2022-04-27"
         release-3.0.0
\end{verbatim}
...
\begin{verbatim}
docker tag parliament-3.0.0-ubuntu idemmons/parliament:3.0.0
docker push idemmons/parliament:3.0.0
\end{verbatim}
