...
/**
 * An iterator that, given an iterator of items, will check each item and
 * return only those that satisfy the {@link ExtentTester}.
 *
 * @author rbattle
 *
 */
public class ExtentTestingIterator implements
   ...
   public ExtentTestingIterator(Iterator<Record<Geometry>> it,
                                Geometry extent, ExtentTester et) {
      this.it = it;
      this.et = et;
      this.extent = extent;
   }
