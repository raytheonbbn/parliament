...
public class ExplorerUtil {
	...
	static {
		...
		labelMap.put(ResourceFactory.createResource(KbGraphStore.DEFAULT_GRAPH_NODE.getURI()), "Default Graph");
	}
	...
	public static String getLabelForResource(Resource resource, Model model) {
		...
		if (label == null) {
			...
			while (labelIter.hasNext()) {
				...
				if (labelObj instanceof Literal literalLabelObj) {
					label = literalLabelObj.getString();
					break;
				}
			}
