...
public class TemporalInstant extends TemporalExtent implements Comparable<TemporalInstant> {
	...
	/** @see com.bbn.parliament.kb_graph.index.temporal.extent.TemporalExtent#getStart() */
	@Override
	public TemporalInstant getStart() {
		return this;
	}

	/** @see com.bbn.parliament.kb_graph.index.temporal.extent.TemporalExtent#getEnd() */
	@Override
