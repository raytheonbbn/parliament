 ...
 * @author dkolas
 */
public abstract class MemoryOperatorImplementation extends
      TemporalPropertyFunction<MemoryTemporalIndex> {
   ...
   /**
    * This isn't exactly the most efficient way to do this, but it will do for
    * now.
    *
   ...
   private class NodeExtentIterator implements
      ...
      public Record<TemporalExtent> next() {
          ...
          */
         // return new
         // Record<TemporalExtent>(index.extentToNode(extent),instant);
      }

      @Override
      public void remove() {
         throw new UnsupportedOperationException(
                                                 "Cannot remove on this iterator!");
      }
