...
public class QueryBuilder {
	 ...
	 * tested.
	 *
	 * @param query2 a Jena query to add as a sub-query.
	 * @return This QueryBuilder instance, to enable method chaining.
	 */
	public QueryBuilder prependSubQuery(Query query2) {
		if (query2 == null) {
			return this;
		}
		query2.usePrologueFrom(query);
		ElementSubQuery subQueryEl = new ElementSubQuery(query2);
	 ...
	 * @return This QueryBuilder instance, to enable method chaining.
	 */
	public QueryBuilder appendSubQuery(Query query2) {
		if (query2 == null) {
			return this;
		}
		query2.usePrologueFrom(query);
