...
public class ExprFactory {
	...
	public static NodeValue nodeValue(boolean value) {
		return new NodeValueBoolean(value);
	}
	...
	public static NodeValue nodeValue(BigDecimal value) {
		return (value == null) ? null : new NodeValueDecimal(value);
	}
	...
	public static NodeValue nodeValue(double value) {
		return new NodeValueDouble(value);
	}
	...
	public static NodeValue nodeValue(Duration value) {
		return (value == null) ? null : new NodeValueDuration(value);
	}
	...
	public static NodeValue nodeValue(float value) {
		return new NodeValueFloat(value);
	}
	...
	public static NodeValue nodeValue(BigInteger value) {
		return (value == null) ? null : new NodeValueInteger(value);
	}
	...
	public static NodeValue nodeValue(long value) {
		return new NodeValueInteger(value);
	}
	...
	public static NodeValue nodeValue(Node value) {
		return (value == null) ? null : new NodeValueNode(value);
	}
	...
	public static NodeValue nodeValue(String value) {
		return (value == null) ? null : new NodeValueString(value);
	}
	...
	public static NodeValue nodeValue(String lex, Node dt) {
		return (lex == null || dt == null) ? null : new NodeValueDT(lex, dt);
	}
	...
	public static Expr equal(String var, Instant value) {
		return (value == null) ? null : new E_Equals(new ExprVar(var),
			new NodeValueDT(value.toString(), XSD.dateTime.asNode()));
	}
	 ...
	 */
	public static Expr equal(String var, long value) {
		return new E_Equals(new ExprVar(var), new NodeValueInteger(value));
	}
	 ...
	 */
	public static Expr equal(String var, double value) {
		return new E_Equals(new ExprVar(var), new NodeValueDouble(value));
	}
	 ...
	 */
	public static Expr lessThanOrEqual(String var, long value) {
		return new E_LessThanOrEqual(new ExprVar(var), new NodeValueInteger(value));
	}
	 ...
	 */
	public static Expr lessThanOrEqual(String var, double value) {
		return new E_LessThanOrEqual(new ExprVar(var), new NodeValueDouble(value));
	}
	 ...
	 */
	public static Expr lessThan(String var, long value) {
		return new E_LessThan(new ExprVar(var), new NodeValueInteger(value));
	}
	 ...
	 */
	public static Expr lessThan(String var, double value) {
		return new E_LessThan(new ExprVar(var), new NodeValueDouble(value));
	}
	 ...
	 */
	public static Expr greaterThanOrEqual(String var, long value) {
		return new E_GreaterThanOrEqual(new ExprVar(var), new NodeValueInteger(value));
	}
	 ...
	 */
	public static Expr greaterThanOrEqual(String var, double value) {
		return new E_GreaterThanOrEqual(new ExprVar(var), new NodeValueDouble(value));
	}
	 ...
	 */
	public static Expr greaterThan(String var, long value) {
		return new E_GreaterThan(new ExprVar(var), new NodeValueInteger(value));
	}
	 ...
	 */
	public static Expr greaterThan(String var, double value) {
		return new E_GreaterThan(new ExprVar(var), new NodeValueDouble(value));
	}
}
