 ...
 *
 * @param <T>
 *           the type of data that is indexed.
 */
public abstract class EstimableIndexPropertyFunction<T>
      extends IndexPropertyFunction<T> {
   ...
   public EstimableIndexPropertyFunction(PropFuncArgType subjArgType,
                                         ...
                                         Class<? extends QueryableIndex<T>> indexClass,
                                         Class<? extends OperandFactory<T>> operandFactoryClass) {
    ...
    *
    * @param subjects
    *           the subjects of the function.
    * @param objects
    *           the objects of the function.
    * @param operands
    *           the current state of the operands.
