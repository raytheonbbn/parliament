...
/// This is a graph that keeps track of the number of statements added, but
/// throws them away and doesn't actually store them. It is useful for syntax
/// verification / count applications.
///
/// @author sallen
