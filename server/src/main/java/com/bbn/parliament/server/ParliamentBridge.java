...
import com.bbn.parliament.server.configuration.ConfigurationHandler;
import com.bbn.parliament.server.configuration.ParliamentBridgeConfiguration;
...
public class ParliamentBridge {
	...
	public static void initialize(String configurationFile, File tmpDir) throws ParliamentBridgeException {
		_instance = new ParliamentBridge(new ParliamentBridgeConfiguration(configurationFile, tmpDir));
	}
