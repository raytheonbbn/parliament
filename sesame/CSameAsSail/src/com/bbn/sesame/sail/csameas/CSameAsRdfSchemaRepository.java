...
// All rights reserved.
// $Id: CSameAsRdfSchemaRepository.java 747 2009-06-08 19:35:56Z tself $
...
public class CSameAsRdfSchemaRepository extends CSameAsRdfRepository implements
RdfSchemaRepository
{
	private RdfSchemaRepository _baseSail;

	public CSameAsRdfSchemaRepository()
	{
		super();
	}
	...
	public void setBaseSail(Sail baseSail)
	{
		...
		else
		{
			throw new SailInternalException(
				"SameAsRdfSource:  base Sail should be an RdfSchemaRepository");
		}
	}
