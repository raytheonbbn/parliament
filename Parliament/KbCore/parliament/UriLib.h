...
public:
	...
	const LazyRsrc m_owlAnnotationProperty;
	const LazyRsrc m_owlAsymmetricProperty;
	const LazyRsrc m_owlCard;
	const LazyRsrc m_owlClass;
	const LazyRsrc m_owlDatatypeProp;
	const LazyRsrc m_owlDeprecatedProperty;
