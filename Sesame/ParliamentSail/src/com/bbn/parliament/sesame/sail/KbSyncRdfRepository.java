...
// All rights reserved.
// $Id: KbSyncRdfRepository.java 747 2009-06-08 19:35:56Z tself $
...
import org.openrdf.sesame.sailimpl.sync.SyncRdfRepository;

/**
 * Allow access to locks from other packages, and ensure that each Thread has at
 * most 1 real read lock.
 */
public class KbSyncRdfRepository extends SyncRdfRepository implements SyncSail
{
